var routes = [
  ...
  {
    path: 'login',
    url: './pages/login-screen-page.html',
    name: 'login',
  },
  // About page
  {
 ...
 
 {
  ...
  {
    path: '/sateachershome/',
    url: './pages/sa-teachers-home.html',
    name: 'sateachershome',
  },
  {
    path: '/sateachersedit/',
    url: './pages/sa-teachers-edit.html',
    name: 'sateachersedit', 
  },
  ...
  // Components
  {
    path: '/accordion-listing/',
    url: './pages/accordion-question.html',
  },
  {
    path: '/action-sheet/',
  ...
  {
    path: '/gauge/', // for reports and stats
    componentUrl: './pages/gauge.html',
  },
  {
    path: '/grid/',// for layout 
    url: './pages/grid.html',
  },
  {
    path: '/icons/', //for icons
    componentUrl: './pages/icons.html',
  },
  {
    path: '/infinite-scroll/', //infinite scroll
    componentUrl: './pages/infinite-scroll.html',
  },
  {
    path: '/inputs/', //for input types
  ...
  {
    path: '/login-screen/', //for login screen
  ...
  {
    path: '/panel/', //// most important
    url: './pages/panel.html',
  },
  {
    path: '/photo-browser/', //photo gallery
    componentUrl: './pages/photo-browser.html',
  },
  {
    path: '/picker/', //for pickers
    componentUrl: './pages/picker.html',
  },
  {
    path: '/popup/',///for popup
    componentUrl: './pages/popup.html',
  },
  {
    path: '/popover/', // for tool tips
    url: './pages/popover.html',
  },
  {
    path: '/preloader/', // for loading effects
    componentUrl: './pages/preloader.html',
  },
  {
    path: '/progressbar/', //for progress bars
    componentUrl: './pages/progressbar.html',
  },
  {
    path: '/pull-to-refresh/', // pull to refresh
    componentUrl: './pages/pull-to-refresh.html',
  },
  {
    path: '/radio/', //checked radio button
    url: './pages/radio.html',
  },
  {
    path: '/range/', // range pickers
    componentUrl: './pages/range.html',
  },
  {
    path: '/searchbar/', //autocomplete
    url: './pages/searchbar.html',
  },
  {
    path: '/searchbar-expandable/',//autocomplete
  ...
  {
    path: '/smart-select/', //for smart selects
  ...
  {
    path: '/stepper/', //steppers with + and -
  ...
  {
    path: '/swiper/', ////slider for gallery
  ...
  {
    path: '/toast/', ///for alerts toast
    componentUrl: './pages/toast.html',
  },
  {
    path: '/toggle/',  //// for on off switches
